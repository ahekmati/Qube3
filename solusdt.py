...
# ========= CONFIG =========
PRODUCT_ID = "SOL-USDC"          # Quote in USDC to spend USDC directly. [web:62]
GRANULARITY = "ONE_DAY"          # Daily timeframe. [web:62]
CANDLE_COUNT = 240               # History for EMAs and ATR. [web:62]
STOP_OFFSET = 8.0                # SL trigger = EMA18 − STOP_OFFSET (USDC). [web:72]
FIXED_RISK_USD = 100.0           # Spend this USDC per entry via quote_size. [web:27]
ATR_WINDOW = 14                  # ATR period (daily). [web:126]
ATR_MULT = 2.0                   # TP = last_close + ATR_MULT × ATR(14). [web:126][web:131]
STOP_ORDER_TAG = "ema_stop"      # Tag for manual stops; brackets won’t use it. [web:72]

# Venue increments; will be overridden from product metadata if available
QUOTE_TICK = Decimal("0.01")     # Quote min increment. [web:63]
BASE_STEP  = Decimal("0.0001")   # Base min increment. [web:63]

ONE_DAYSEC = 24 * 3600  # [web:62]
